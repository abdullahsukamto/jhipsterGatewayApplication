package co.mitrasol.application.repository;

import co.mitrasol.application.JhipsterGatewayApplicationApp;
import co.mitrasol.application.config.Constants;
import co.mitrasol.application.config.audit.AuditEventConverter;
import co.mitrasol.application.domain.PersistentAuditEvent;
...
import static co.mitrasol.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
