package co.mitrasol.application.web.rest;

import co.mitrasol.application.config.Constants;
import co.mitrasol.application.JhipsterGatewayApplicationApp;
import co.mitrasol.application.domain.Authority;
import co.mitrasol.application.domain.User;
import co.mitrasol.application.repository.AuthorityRepository;
import co.mitrasol.application.repository.UserRepository;
import co.mitrasol.application.security.AuthoritiesConstants;
import co.mitrasol.application.service.MailService;
import co.mitrasol.application.service.dto.UserDTO;
import co.mitrasol.application.web.rest.errors.ExceptionTranslator;
import co.mitrasol.application.web.rest.vm.KeyAndPasswordVM;
import co.mitrasol.application.web.rest.vm.ManagedUserVM;
import co.mitrasol.application.service.UserService;
